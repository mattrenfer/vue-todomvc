...
new Vue({
  ...
  computed: {
    ...
    // Returns a list of todos with the incompleted ones removed, when the application is so configured.
    filteredIncompleteTodos() {
      return this.todos.filter((todo) =>
        this.showIncomeComplete ? true : todo.complete
      );
    },
